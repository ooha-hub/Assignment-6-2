...
%
\section{solution}
Given that axis is along the x-axis.\\So, vector equation of the parabola is,
\begin{align}
\vec{x}^T\myvec{0 & 0 \\ 0 & 1}\vec{x} + 2\myvec{-2a & 0}\vec{x} + 0 = 0
\end{align}
\begin{align}
 \vec{V} = \myvec{0 & 0 \\ 0 & 1} ,
 \vec{u} = \myvec{-2a \\ 0} ,
...
\\
\eta = \vec{u}^T\vec{p_1} = -2a
\end{align}
$\therefore$ \myvec{2 & 2} satisfies it.
\begin{align}
\myvec{2 & 2}\myvec{0 & 0 \\ 0 & 1} \myvec{2 \\ 2} + 2\myvec{-2a & 0}\myvec{2 \\ 2} = 0
\\
\implies \myvec{0 & 2} \myvec{2 \\ 2} + \myvec{-4a  & 0}\myvec{2 \\ 2} = 0
\end{align}
\begin{align}
 \implies 4 - 8a = 0
 \\
